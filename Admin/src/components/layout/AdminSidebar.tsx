...
const navItems = [
  ...
  { title: "Establecimientos", url: "/establishments", icon: Building2 },
...
const systemItems = [
  { title: "Moderación", url: "/moderation", icon: Shield },
  { title: "Notificaciones", url: "/notifications", icon: Bell },
  { title: "Analytics", url: "/metrics", icon: BarChart3 },
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center h-14 px-3 border-b border-sidebar-border">
        ...
        {!collapsed && (
          <div className="ml-2">
            <span className="font-semibold text-sm text-foreground">Bookwise</span>
