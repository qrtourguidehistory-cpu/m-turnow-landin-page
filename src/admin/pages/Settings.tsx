            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input defaultValue="Mí Turnow Admin" />
                </div>
                <div className="space-y-2">
                  <Label>Versión</Label>
          ...
          <TabsContent value="apps" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Estado de conexión con las apps del ecosistema Mí Turnow</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">Mí Turnow Partner</p>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">Mí Turnow Cliente</p>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">Mí Turnow Admin</p>
